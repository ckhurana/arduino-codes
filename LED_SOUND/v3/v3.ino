...
#define COLOR_SHIFT 18000  // Time for colours to shift to a new spectrum (in ms)
...
#define BRIGHT_PIN A0        // brightness input from amplified audio signal
...
void loop() { 
  ...
  Color nc = pitchConv(newPitch, analogRead(PITCH_PIN));
